...
export class PushNotificationService {
  ...
  readonly VAPID_PUBLIC_KEY = 'YOUR_VAPID_PUBLIC_KEY'; // environment.vapidPublicKey;
  private apiUrl = `/api/push`;
  ...
  private sendToServer(params: PushSubscription) {
    this.http.post(`${this.apiUrl}/subscribe`, params).subscribe();
  }
}
